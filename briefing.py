#!/usr/bin/env python3
"""Daily market briefing — Claude Opus 4.6 + Tavily + Gmail SMTP."""
...
def generate_briefing(client: anthropic.Anthropic, date: str, search_results: str) -> str:
...
<body>
  ...
  {body}
  <p class="footer">Generated by Claude Opus 4.6 &middot; For informational purposes only &middot; Not investment advice.</p>
</body>
</html>"""
...
def main() -> None:
    ...
    print("[3/4] Generating briefing with Claude Opus 4.6...")
    briefing_html = generate_briefing(claude, date, search_results)
